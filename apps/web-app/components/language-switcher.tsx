...
import { useChangeLocale, useCurrentLocale, useI18n } from "@repo/internationalization/lib/client";
...
export const LanguageSwitcher = () => {
	...
	return (
		<div>
			<Select
				onValueChange={(value: (typeof languageValues)[number]) => changeLocale(value)}
